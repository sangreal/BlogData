...
date: 2016-06-14 18:37:37
tags: [LeetCode, System Design]
---

## Analysis:
> we can use a map with a set as value for followership. And a map with list as value for tweets storage. The important step is to use counter to determine the sequence of the tweets.
